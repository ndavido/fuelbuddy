...
model = Sequential()
model.add(SimpleRNN(256, return_sequences=True, input_shape=(look_back, 1), activation='tanh', kernel_regularizer=l2(0.01)))
model.add(Dropout(0.2))
model.add(SimpleRNN(128, return_sequences=True, activation='tanh', kernel_regularizer=l2(0.01)))
model.add(Dropout(0.2))
model.add(SimpleRNN(64, return_sequences=True, activation='tanh', kernel_regularizer=l2(0.01)))
model.add(Dropout(0.2))
