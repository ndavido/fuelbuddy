...
__all__ = [account, delete_account, logout, edit_account, upload_profile_picture, register, verify, login, login_verify, update_budget, get_past_budgets, update_user_deduction, get_deductions, reset_weekly_budgets, send_friend_request, list_friends, received_friend_requests, sent_friend_requests, respond_friend_request, cancel_friend_request, remove_friend, search_users, view_friend_profile, friend_activity_dashboard, get_favorite_fuel_stations, get_past_petrol_prices, add_rating_to_fuel_station, get_fuel_stations,
