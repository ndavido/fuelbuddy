...
from src.services.vehicle_service import (get_vehicle_makes, get_vehicle_models_for_makes, get_vehicle_years_for_model,
...
vehicle_blueprint.route('/vehicle_models/<make>', methods=['GET'])(get_vehicle_models_for_makes)
vehicle_blueprint.route('/vehicle_years/<model>', methods=['GET'])(get_vehicle_years_for_model)

# GET User Vehicle method
vehicle_blueprint.route('/get_user_vehicle', methods=['POST'])(get_user_vehicle)
