...
from src.services.budget_service import update_budget, get_deductions, user_suggested_budget, reset_weekly_budgets, update_user_deduction, save_weekly_data, get_weekly_budgets
...
budget_blueprint.route(
    '/user_suggested_budget', methods=['POST'])(user_suggested_budget)
budget_blueprint.route(
...
budget_blueprint.route(
    '/get_weekly_budgets', methods=['POST'])(get_weekly_budgets)
