...
import { Marker as GMMarker, OverlayView as GMOverlayView, useGoogleMap } from '@react-google-maps/api';
...
function MarkerF(props) {
  ...
  return /*#__PURE__*/React.createElement(CalloutContext.Provider, {
    ...
    onDrag: e => {
      var _props$onDrag;
      return (_props$onDrag = props.onDrag) === null || _props$onDrag === void 0 ? void 0 : _props$onDrag.call(props, mapMouseEventToMapEvent(e, props.coordinate, map, ''));
    },
    onDragStart: e => {
      var _props$onDragStart;
      return (_props$onDragStart = props.onDragStart) === null || _props$onDragStart === void 0 ? void 0 : _props$onDragStart.call(props, mapMouseEventToMapEvent(e, props.coordinate, map, ''));
    },
    onDragEnd: e => {
      var _props$onDragEnd;
      return (_props$onDragEnd = props.onDragEnd) === null || _props$onDragEnd === void 0 ? void 0 : _props$onDragEnd.call(props, mapMouseEventToMapEvent(e, props.coordinate, map, ''));
    },
    options: {
