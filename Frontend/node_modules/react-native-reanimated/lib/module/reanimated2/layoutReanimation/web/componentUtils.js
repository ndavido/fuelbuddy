...
function getEasingFromConfig(config) {
  const easingName = config.easingV !== undefined &&
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  config.easingV.name in WebEasings ?
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  config.easingV.name : 'linear';
...
function getDelayFromConfig(config) {
  ...
  return shouldRandomizeDelay ? getRandomDelay(config.delayV) :
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  config.delayV / 1000;
}
...
function getDurationFromConfig(config, isLayoutTransition, animationName) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  config.durationV / 1000 : defaultDuration;
}
