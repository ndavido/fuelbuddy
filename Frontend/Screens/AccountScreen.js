        ...
        <Main>
            ...
            <WrapperScroll refreshControl={
                ...
                <AccountContainer>
                    ...
                    <H8 tmargin='50px' bmargin='5px' width='100%' style={{opacity: 0.5, textAlign: 'center'}}>Version
                        Alpha</H8>
                    <H8 bmargin='25px' width='100%' style={{opacity: 0.5, textAlign: 'center'}}>Made with 💖 by Team
                        fuelbuddy</H8>
