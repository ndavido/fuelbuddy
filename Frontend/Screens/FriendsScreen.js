      ...
      <Main>
        ...
        >
          <AccountContainer style={{ minHeight: 800 }}>
            <H3 tmargin="20px" lmargin="0px" bmargin="5px">
              Friends
            </H3>
            <ButtonContainer
                          ...
                          <View style={styles.friendItem} key={item.request_id}>
                            ...
                            >
                              <ButtonButton
                                ...
                                color={"#6BFF91"}
                                onPress={() =>
                                  decideFriend(item.request_id, "accept")
                                }
                              />
                              <ButtonButton
                                color={"#3891FA"}
                                text={"Deny"}
                                onPress={() =>
                                  decideFriend(item.request_id, "reject")
                                }
                              />
                            </View>
                          </View>
              ...
              <View>
                {friends.map((item) => (
                  <View style={styles.friendItem} key={item.friend_id}>
                    <H6 weight="400" bmargin="5px" style={{ opacity: 0.5 }}>
                      {item.friend_name}
                    </H6>
                  </View>
                ))}
                              ...
                              >
                                {pendingRequests.includes(item.phone_number) ? (
                                  ...
                                  <ButtonButton
                                    ...
                                    color={"#6BFF91"}
                                    onPress={() =>
                                      handleMakeFriend(item.phone_number)
                                    }
                                  />
                                )}
                              </View>
